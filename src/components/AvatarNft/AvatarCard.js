...
const AvatarCard = ({sellerData}) => {
    ...
    return (
        <div className='xl:col-span-2 s:col-span-4 sm:col-span-3 col-span-6  bg-[#343444] rounded-lg text-white flex lg:flex-row flex-col items-center justify-center py-4 px-2 md:px-3 sm:mb-0'>
