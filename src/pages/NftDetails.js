...
const NftDetails = () => {
    ...
    const {title, desc, imgUrl, creator, creatorImg, currentBid} = dataD
    ...
    return (
            <>
                <Poster/>
                <div className='text-white w-full mt-28 lg:mt-32'>
                    <div className='max-w-[640px] md:max-w-[900px] lg:max-w-[1024px] xl:max-w-[1320px] mx-auto h-full px-4 flex flex-col lg:flex-row items-center justify-center'>
                        <div className='w-[600px] h-[600px] rounded-2xl overflow-hidden'><img src={imgUrl} alt="NFT_Image" /></div>
                        <div className='w-1/2 text-white p-8'>
                            ...
                            <p className='mb-10 text-stone-200 leading-9'>{desc}</p>
                            <Link className='flex font-medium items-center justify-center bg-[#5142fc] hover:bg-white hover:ring-2 hover:ring-[#5142fc] hover:text-[#5142fc] transition-all duration-300 rounded-full py-2' to='/wallet'><BsBasket className='mr-2'/>Place a Bid</Link>
                        </div>
                    </div>
                </div>
            </>
